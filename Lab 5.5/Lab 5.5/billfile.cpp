...
int main()
{
	...
	cin >> quantity >> itemPrice; // Fill in the input statement that brings in the
	...
	dataOut << totalBill;		// Fill in the output statement that prints the total bill, with a label,
												// to an output file
	dataIn.close();
	dataOut.close();
	return 0;
